        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    <li class="breadcrumb-item"><a href="https://bestwebcreator.com/shopwise/demo/term-condition.html#">Home</a></li>
                    <li class="breadcrumb-item"><a href="https://bestwebcreator.com/shopwise/demo/term-condition.html#">Pages</a></li>
