        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active"><?= lang('checkout') ?></li>
                </ol>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
            	<div class="toggle_info">
                	<span><i class="fas fa-user"></i>Returning customer? <a href="<?= lang('login_to_acc') ?>" data-toggle="collapse" class="collapsed" aria-expanded="false"><?= lang('login_to_acc') ?></a></span>
                </div>
                    ...
                    <div class="panel-body">
                    	...
                    	<form method="post">
                            ...
                            <div class="login_footer form-group">
                                ...
                                <a href="https://bestwebcreator.com/shopwise/demo/checkout.html#">Forgot password?</a>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-lg-6">
            	<div class="toggle_info">
            		<span><i class="fas fa-tag"></i>Have a coupon? <a href="https://bestwebcreator.com/shopwise/demo/checkout.html#coupon" data-toggle="collapse" class="collapsed" aria-expanded="false">Click here to enter your code</a></span>
                </div>
        ...
        <div class="row">
        	<div class="col-md-6">
                ...
                <?php
                    ...
                    <div class="form-group">
                        <input type="text" id="firstNameInput" required="" class="form-control" name="first_name" value="<?= @$_POST['first_name'] ?>"placeholder="First name *">
                    </div>
                    <div class="form-group">
                        <input type="text" id="lastNameInput" required="" class="form-control" name="last_name" value="<?= @$_POST['last_name'] ?>" placeholder="Last name *">
                    </div>
                    <div class="form-group">
                        <input type="text" id="phoneInput" required="" class="form-control" name="phone" value="<?= @$_POST['phone'] ?>" placeholder="Phone *">
                    </div>
                    <div class="form-group">
                    <input id="postInput" name="post_code" value="<?= @$_POST['post_code'] ?>" type="text" placeholder="<?= lang('post_code') ?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="order_review">
                    ...
                    <a href="<?= lang('home') ?>" class="btn btn-fill-out btn-block">Place Order</a>
                </div>
            </div>
        </div>
    </div>
